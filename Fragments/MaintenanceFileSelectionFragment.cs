...
namespace com.companyname.navigationgraph7net7.Fragments
{
    public class MaintenanceFileSelectionFragment : Fragment, IMenuProvider
    {
        ...
        public void OnPrepareMenu(IMenu menu)
        {
            ...
            // A quick fix just for this example for demo purposes, since we don't have any data in this example in NavigationGraph7Net7
            menuItemAskPermission!.SetEnabled(true);
            menuItemCopyFile!.SetEnabled(false);
        }
        #endregion
        ...
        public override void OnDestroy()
        {
            ...
            // Make sure the MainActivity can rotate again
